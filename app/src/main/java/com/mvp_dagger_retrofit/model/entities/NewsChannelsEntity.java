...
public class NewsChannelsEntity extends BaseEntity{
    ...
    public boolean isSuccess() {
        return showapi_res_code == SUCCESS_CODE && getShowapi_res_body() != null && getShowapi_res_body().isSuccess();
    }

    public static class ShowapiResBodyEntity extends BaseEntity {
